...
namespace Vulkan.Win32
{
		...
		public static SurfaceKhr CreateWin32SurfaceKHR (this Instance instance, Win32SurfaceCreateInfoKhr pCreateInfo, AllocationCallbacks pAllocator)
		{
			...
			unsafe {
				...
				fixed (UInt64* ptrpSurface = &pSurface.m) {
					result = Win32.Interop.NativeMethods.vkCreateWin32SurfaceKHR (instance.m, pCreateInfo.m, pAllocator != null ? pAllocator.m : null, ptrpSurface);
				}
	...
	public static class PhysicalDeviceExtension
	{
		...
		{
			unsafe {
				return Win32.Interop.NativeMethods.vkGetPhysicalDeviceWin32PresentationSupportKHR (physicalDevice.m, queueFamilyIndex);
			}
		}
	}
